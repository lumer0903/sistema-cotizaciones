...
export function ColorConfigModal({ open, onClose, onSave, initialColors }: ColorConfigModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="Configuración de colores">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {isAdding ? (
              ...
              <button
                ...
                className="text-sm font-medium text-brand-subtitle hover:underline underline-offset-2 ml-1"
              >
                Añadir color
              </button>
            )}

import { ChevronDown, ChevronRight, FileText, LayoutDashboard, LogOut, Menu, Package, Search, Users, X } from 'lucide-react';
...
const items = [
  ...
  ['/productos', Package, 'Productos', 'productos'],
  ['/consulta-precios', Search, 'Consulta de precios', 'consulta_precios'],
  ['/cotizaciones', FileText, 'Cotizaciones', 'cotizaciones'],

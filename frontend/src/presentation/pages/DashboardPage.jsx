...
import { AlertTriangle, BadgeDollarSign, CheckCircle2, Clock3, FileText, Package, PieChart, TrendingUp } from 'lucide-react';
...
const states = {
  borrador: ['Borrador', '#a1a1aa'], // neutral-400
  enviada: ['Enviado', '#3b82f6'],   // blue-500
  aprobada: ['Aprobado', '#10b981'],  // emerald-500
  rechazada: ['Rechazado', '#ef4444']  // red-500
};
...
export function DashboardPage() {
  ...
  const cards = [
    [Package, 'Total de productos', data ? metrics.totalProductos : '...', 'bg-[#f8fafc] text-[#414141] border border-[#d9d9d9]', '/productos'],
    [CheckCircle2, 'Cotizaciones aceptadas', data ? metrics.cotizacionesAceptadas : '...', 'bg-[#f8fafc] text-[#414141] border border-[#d9d9d9]', '/cotizaciones?estado=aprobada'],
    [BadgeDollarSign, 'Ventas del mes', data ? money(metrics.totalVentasMes) : '...', 'bg-[#f8fafc] text-[#414141] border border-[#d9d9d9]', '/cotizaciones?estado=aprobada'],
    [FileText, 'Cotizaciones del mes', data ? metrics.totalCotizaciones : '...', 'bg-[#f8fafc] text-[#414141] border border-[#d9d9d9]', '/cotizaciones']
  ];
  ...
  return (
    <AppLayout title="Dashboard">
      <div className="space-y-8 select-none">
        ...
        <section className="grid gap-6 lg:grid-cols-3">
          ...
          <article className="lg:col-span-2 rounded-2xl border border-[#d9d9d9] bg-white p-6 shadow-xs">
            <div className="flex items-center justify-between border-b border-[#d9d9d9] pb-4 mb-6">
              <div>
                <h3 className="text-sm font-semibold text-[#414141]">Ventas aprobadas</h3>
                <p className="text-[11px] text-neutral-400">Historial mensual acumulado</p>
              </div>
          ...
          <article className="rounded-2xl border border-[#d9d9d9] bg-white p-6 shadow-xs flex flex-col justify-between">
            <div className="flex items-center justify-between border-b border-[#d9d9d9] pb-4 mb-6">
              <div>
                <h3 className="text-sm font-semibold text-[#414141]">Distribución</h3>
                <p className="text-[11px] text-neutral-400">Estados de cotizaciones</p>
              </div>
            ...
            <div className="flex-1 flex flex-col justify-center py-4">
              ...
              >
                {/* Agujero central para hacer el donut */}
        ...
        {/* Listas Detalladas (Bajo Stock y Movimientos Recientes) */}
        <section className="grid gap-6 lg:grid-cols-2">
          ...
          <article className="rounded-2xl border border-[#d9d9d9] bg-white p-6 shadow-xs flex flex-col justify-between">
            <div className="flex items-center justify-between border-b border-[#d9d9d9] pb-4 mb-4">
              <div>
                ...
                <p className="text-[11px] text-neutral-400">Productos con stock bajo el límite configurado</p>
              </div>
          ...
          {/* Panel Últimas Cotizaciones */}
          <article className="rounded-2xl border border-[#d9d9d9] bg-white p-6 shadow-xs flex flex-col justify-between">
            <div className="flex items-center justify-between border-b border-[#d9d9d9] pb-4 mb-4">
              <div>
                <h3 className="text-sm font-semibold text-[#414141]">Actividad reciente</h3>
                <p className="text-[11px] text-neutral-400">Últimos movimientos de cotizaciones generadas</p>
              </div>
              <Clock3 className="h-4 w-4 text-[#414141]/60" />
            </div>
